...
public class MyApplication extends Application implements Application.ActivityLifecycleCallbacks, LifecycleObserver {
    ...
    //test ads id admob
    public static String AdMob_Banner1 = "ca-app-pub-9357339198359374/8597060727";  // add google admob banner ads id
    public static String AdMob_Int1 = "ca-app-pub-9357339198359374/6760384814";     // add google admob interstitial ads id 1
    public static String AdMob_Int2 = "ca-app-pub-9357339198359374/6760384814";     // add google admob interstitial ads id 2
    public static String AdMob_NativeAdvance1 = "ca-app-pub-9357339198359374/9313013072";  // add google admob native ads id 1
    public static String AdMob_NativeAdvance2 = "ca-app-pub-9357339198359374/9313013072";  // add google admob native ads id 2
    public static String App_Open = "ca-app-pub-9357339198359374/2859285364";  // add google admob openapp ads id
    ...
    public static String MAX_Banner = "YOUR_AD_UNIT_ID";  //add app lovin MAX banner ads id
    public static String MAX_Int = "YOUR_AD_UNIT_ID";     //add app lovin MAX interstitial ads id
    public static String MAX_Native = "YOUR_AD_UNIT_ID";  //add app lovin MAX native ads id
    ...
    public static String PrivacyPolicy = "https://calculatorwall.com/privacy-policy/";  //your_privacy_policy_here
